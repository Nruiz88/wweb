      ...
      <main className="flex min-w-0 flex-1 flex-col gap-6">
        <header className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-100">
              ...
              {view === "conversaciones" && "Conversaciones"}
              {view === "recibidos" && "Mensajes recibidos"}
            </h1>
            <p className="text-sm text-slate-400">
              {view === "panel"
                ? "Estado de la instancia y envío de mensajes"
                : view === "conversaciones"
                  ? "Historial real y respuestas por chat"
                  : "Entrada en tiempo real vía webhook"}
            </p>
          </div>
        ...
        {view === "panel" && (
          <>
            ...
            <section className="glass-panel fade-up flex flex-col gap-5 p-6">
              <SectionHeader
        ...
        {view === "recibidos" && (
          <section className="glass-panel fade-up p-6">
            <SectionHeader
              ...
              title="Entrada en tiempo real"
              description="Últimos mensajes recibidos por webhook"
            />
            <div className="mt-5">
